<?php
    ...
    if(isset($_POST['submit'])){
      ...
      $fburl = mysqli_real_escape_string($conn,$_POST['fburl']);
      $twurl = mysqli_real_escape_string($conn,$_POST['twurl']);
    ...
    //Insert data for agent
    $sql = "INSERT INTO agent VALUES('$id', '$name', '$bio', '$fburl', '$twurl', '$url', '$img')";
...
<div id="wrapper">
     <!-- Navigation -->
            ...
            <ul class="nav navbar-nav navbar-right">
			    ...
			    <li class="dropdown">
	        		...
	        		<ul class="dropdown-menu">
						...
						<li class="m_2"><a href="./function/logout.php"><i class="fa fa-lock"></i> Logout</a></li>	
	        		</ul>
	      		</li>
			</ul>
	   ...
	   <div class="xs">
        ...
        <form method="POST" enctype="multipart/form-data" class="form-floating ng-pristine ng-invalid ng-invalid-required ng-valid-email ng-valid-url ng-valid-pattern" novalidate="novalidate" ng-submit="submit()">
          <fieldset>
            ...
            <div class="form-group">
              ...
              <input type="text" name="bio" class="form-control1 ng-invalid ng-invalid-required ng-touched" ng-model="model.text" required="">
            </div>
            <div class="form-group">
              <label class="control-label">Facebook Link</label>
              <input type="url" name="fburl" class="form-control1 ng-invalid ng-valid-url ng-invalid-required ng-touched" ng-model="model.url" required="">
            </div>
            <div class="form-group">
              <label class="control-label">Twitter Link</label>
              <input type="url" name="twurl" class="form-control1 ng-invalid ng-valid-url ng-invalid-required ng-touched" ng-model="model.url" required="">
            </div>
            <!--<div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="url" name="url" class="form-control1 ng-invalid ng-valid-url ng-invalid-required ng-touched" ng-model="model.url" required="">
            </div>
            <div class="form-group">
