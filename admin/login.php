<?php 
    ...
    if(isset($_POST['login'])){
        ...
        //Select query 
        $sql = "SELECT * FROM `login` WHERE `mail`='$mail' AND `password` = '$password'";
...
<body id="login">
  ...
  <div class="app-cam">
	  <form method="post">
		<input type="text" class="text" name="mail" value="E-mail address" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'E-mail address';}">
